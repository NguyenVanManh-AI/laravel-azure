...
<body>
    ...
    text-align: center;
    ">
        <p style="font-style: italic;margin: 0;margin-bottom: 10px;">Xin chào bạn ! Bạn có một thông báo đến từ hệ thống Elister Health Care !</p>
        <p style="margin: 0;margin-bottom: 5px;">{{ now() }}</p>
    </div>

    <div style="background-color: #007eff1c;padding: 20px;border: 2px dashed #007bff;">
        <p>
            <p><h4>Hãy sử dụng tài khoản này để đăng nhập vào hệ thống và đổi mật khẩu !</h4></p>
            <p>Email : <span style="font-weight: bold; ">{{$email}}</span> </p>
            <p>Password : <span style="font-weight: bold; ">{{$new_password}}</span> </p>
        </p>
    </div>
    ...
    text-align: center;
    ">
    <p style="margin: 0;margin-bottom: 10px;">Nếu bạn có bất kỳ câu hỏi nào, vui lòng gửi email cho chúng tôi theo địa chỉ <a style="font-weight: bold;color: rgb(0, 123, 255);" href="mailto:help@elisterhealthcare.com">help@elisterhealthcare.com</a> hoặc truy cập <a style="font-weight: bold;color: rgb(0, 123, 255);" href="FAQs">FAQs</a> của chúng tôi.</p>
    <p style="margin: 0;margin-bottom: 10px;">Bạn cũng có thể trò chuyện với người thật trong giờ làm việc của chúng tôi. Họ có thể trả lời các câu hỏi về tài khoản của bạn hoặc giúp bạn giải đáp các thắt mắc khác.</p>
    ...
    <p style="margin: 0;margin-bottom: 10px;">54 Nguyễn Lương Bằng, phường Hòa Khánh Bắc, Quận Liên Chiểu , Đà Nẵng , Việt Nam</p>
    <p style="margin: 0;margin-bottom: 10px;">Số điện thoại công ty : <a style="font-weight: bold;color: rgb(0, 123, 255);" href="tel:+01236000333">01236000333</a></p>
